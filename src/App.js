    ...
    <Container >
      <Row className=''>
        <Col className='bg-white'>
          ...
          <p className='text-center p-3 bg-white'><b>Pokémon es una franquicia de videojuegos que comenzó siendo de tipo RPG para las consolas de Nintendo creada por Satoshi Tajiri en 1995. Esta es la lista de Pokémon completa ordenada según el número en la Pokédex Nacional. En esta se muestra el nombre del Pokémon en español.</b></p>
        </Col>
